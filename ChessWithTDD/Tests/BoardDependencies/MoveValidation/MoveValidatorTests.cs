    ...
    public class MoveValidatorTests
    {
        ...
        public void MoveIsValidReturnsTrueIfAllValidationPasses()
        {
            ...
            multiMoveValidator.Stub(mmv =>
                ...
                .Return(false);
            IEnPassantManager enPassantManager = GenerateMock<IEnPassantManager>();
            enPassantManager.Stub(ep =>
                ep.MoveIsInvalidEnPassantCapture(fromSquare, toSquare, board))
                .Return(false);

            MoveValidator moveValidator = new MoveValidator(genericMoveValidator, multiMoveValidator, enPassantManager);
        ...
        [Test]
        public void MoveIsValidReturnsFalseIfJustEnPassantValidationFails()
        {
            ISquare fromSquare = MockSquare();
            ISquare toSquare = MockSquare();
            IBoard board = MockBoard();
